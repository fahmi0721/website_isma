...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Update Kontak</h5></div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Update Kontak</div></div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action='javascript:void(0)' enctype="multipart/form-data" id="form_data">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="section" id="section" class='form-control'>
                                    ...
                                    <option value="contact" {{ $data->section === "contact" ? "selected" : "" }}>Contact</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ $data->type }}" id="type" name="type" placeholder="Type" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ $data->label }}" id="label" name="label" placeholder="Label" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{ $data->value }}" id="value" name="value" placeholder="Value" />
                            </div>
                        </div>
                    </div>
                    <!--end::Body-->
...
<script>
    proses_data = function(){
        ...
        $.ajax({
            type    : "POST",
            url     : "{{ route('admin.kontak.update', [':id']) }}".replace(':id', id),
            data    : iData,
            cache   : false,
            processData: false,
            contentType: false,
