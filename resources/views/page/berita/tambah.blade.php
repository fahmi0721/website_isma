...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Create New Berita</h5></div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Create New Berita</div></div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action='javascript:void(0)' enctype="multipart/form-data" id="form_data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control"  rows='10' id="isi_berita" name="isi_berita" placeholder="Isi Berita"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="tanggal" class="col-sm-3 col-form-label">Tanggal Berita <b class='text-danger'>*</b></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal Berita" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="tags" class="col-sm-3 col-form-label">Tags <b class='text-danger'>*</b></label>
                            <div class="col-sm-9">
                                <select name="tags[]" id="tags" class="form-control tags" multiple="multiple"></select>
