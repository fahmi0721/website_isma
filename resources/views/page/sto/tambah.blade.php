@extends('layouts.app')
@section('title','Create Struktur Organisasi')
@section('breadcrumb')
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Create Struktur Organisasi</h5></div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Create Struktur Organisasi</div></div>
                <!--end::Header-->
                <!--begin::Form-->
