...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Create Giat</h5></div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline mb-4">
                <div class="card-header"><div class="card-title">Create Giat</div></div>
                <!--end::Header-->
                <!--begin::Form-->
                <form action='javascript:void(0)' enctype="multipart/form-data" id="form_data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label for="jabatan" class="col-sm-3 col-form-label">Deskripsi </label>
                            <div class="col-sm-9">
                        ...
                        <div class="row mb-3">
                            <label for="foto" class="col-sm-3 col-form-label"> Image<b class='text-danger'>*</b></label>
                            <div class="col-sm-9">
                                <input type="file" class="form-control" id="image" name="image" accept="image/*" placeholder="Foto" />
                            </div>
                        </div>
                    </div>
                    <!--end::Body-->
